...
Bir sistemi uçtan uca kurmayı seviyorum: veri modelinden optimizasyon motoruna, API katmanından mobil istemciye kadar. Son dönemde ağırlıklı olarak **çok kriterli optimizasyon**, **LLM tabanlı ajan mimarileri** ve **fizik tabanlı simülasyon** üzerine çalışıyorum.

- 🔭 Şu an **IYONTREE** üzerinde çalışıyorum — elektrikli araçlar için rota ve şarj planlama sistemi
- 🌱 Odağım: sözleşme tabanlı (OpenAPI) geliştirme, deterministik LLM orkestrasyonu, dağıtık servis tasarımı
- 💬 Optimizasyon, .NET / FastAPI mimarileri veya Android tarafı hakkında konuşmak istersen çekinme
